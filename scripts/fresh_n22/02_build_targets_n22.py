...
EXONS   = f"{FRESH}/n22_exons.fa"
IDX     = f"{FRESH}/n22_exons_idx"
OUTDIR  = f"{FRESH}/targets/{CLASS}"
SAMOUT  = f"{FRESH}/{CLASS}_exons_max_0.sam"
GENES   = f"{FRESH}/genes_{CLASS}_analysis.txt"
os.makedirs(OUTDIR, exist_ok=True)

def rc(s): return s.translate(str.maketrans("ACGT","TGCA"))[::-1]

# ---- 1. build a bowtie query FASTA of the class guides (both strands) -------
qry = f"{FRESH}/{CLASS}_guides.fa"
ng = 0
...
with open(SAMOUT) as fh:
    for ln in fh:
        ...
        # OsN22 tx id = OsN22_01G000010_01 ; parent gene = OsN22_01G000010
